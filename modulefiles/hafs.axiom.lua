help([[
loads HAFS application level modulefile on the Axiom Azure cloud cluster.
]])
...
prepend_path("MODULEPATH", "/lustre/work/HPC-Stack/modulefiles/stack/")
hpc_ver=os.getenv("hpc_ver") or "1.2.0"
load(pathJoin("hpc", hpc_ver))

hpc_intel_ver=os.getenv("hpc_intel_ver") or "2021.5.0"
load(pathJoin("hpc-intel", hpc_intel_ver))

hpc_impi_ver=os.getenv("hpc_impi_ver") or "2021.7.1"
